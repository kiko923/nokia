...
// var name=decodeURI(test.split("?name=")[1]);
...
//     document.getElementById('text').value = name;
// } else {
//     document.getElementById('text').value = ''; // 如果 name 未定义或为空，则设置为空
// }
...
document.addEventListener('gesturestart', function(event) {
    ...
    function(t, e, n) {
        ...
        var r = n(0),
            ...
            y = (n(7), function() {
                function t() {
                    a()(this, t), l()(this, "isPatina", !1), l()(this, "originImage", void 0), l()(this, "imgElement", void 0), l()(this, "readyFlag", !1), l()(this, "generating", !1), l()(this, "imageFilename", "科技兽"), this.registerEvent(), this.fillModalContent()
                }
                return s()(t, [{
                    key: "fetchImage",
                    value: function() {
                                ...
                                case 0:
                                    return t.abrupt("return", new Promise((function(t) {
                                        ...
                                        e.crossOrigin = "Anonymous", e.onload = function(n) {
                                            t(e)
                                        }, e.src = "https://cdn.jsdelivr.net/gh/kiko923/nokia/no-author/images/nokia.png"
                                    })));
                                case 1:
                                case "end":
                                    return t.stop()
                    ...
                    value: function() {
                        return o.a.async((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 5:
                                    return t.next = 7, o.a.awrap(this.generateImage('有内鬼 终止交易'));
                                case 7:
                                    this.loading(!1);
                                case 8:
                                case "end":
                    ...
                    value: function(t) {
                        ...
                        e && n && (t ? (n.style.visibility = "hidden", e.textContent = "努力加载中...", this.readyFlag = !1) : (n.style.visibility = "visible", e.textContent = "长按保存图片(失败请点绿色按钮)", this.readyFlag = !0))
                    }
                }]), t
            }());
