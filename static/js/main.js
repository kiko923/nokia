          ...
          if (
            ...
            !(function (t) {
              ...
              (E.dir = "ltr"),
                ...
                r(h, f(o, '"' + o.family + '",sans-serif')),
                i(p, function (t) {
                  (y = t), s();
                }),
                r(p, f(o, '"' + o.family + '",serif')),
                i(g, function (t) {
                  (v = t), s();
                }),
      ...
      y =
        ...
        (function () {
          function t() {
            a()(this, t),
              l()(this, "isPatina", !1),
              l()(this, "originImage", void 0),
              l()(this, "imgElement", void 0),
              l()(this, "readyFlag", !1),
              l()(this, "generating", !1),
              l()(this, "imageFilename", "ZZKIA"),
              l()(this, "donateModal", void 0),
              l()(this, "payModal", void 0),
              l()(this, "weappModal", void 0),
              this.registerEvent(),
            ...
            s()(t, [
                          ...
                          return t.abrupt(
                            ...
                            new Promise(function (t) {
                              ...
                              (e.crossOrigin = "Anonymous"),
                                ...
                                (e.src =
                                  "https://cdn.jsdelivr.net/gh/dcalsky/zzkia/api/images/3.jpg");
                            })
                          );
                        case 1:
                        case "end":
              ...
              },
              {
                ...
                value: function () {
                  ...
                  document
                    ...
                    document
                      .getElementById("weapp")
                      .addEventListener("click", function (e) {
                        t.weappModal.open();
                      }),
                    document
                      .getElementById("patina")
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (t.download = "".concat(this.imageFilename, ".png")),
                    (t.style.display = "none"),
                    (t.href = this.imgElement.src),
                                ...
                                if (o) {
                                  ...
                                  for (
                                    ...
                                    var s = a[4 * c],
                                      ...
                                      f = g(
                                        ((128 * s - 107 * u - 21 * l) >> 8) - 1
                                      ),
                                      m = p((65536 * h + 91881 * f) >> 16),
                                      y = p(
                                        (65536 * h - 22553 * d - 46802 * f) >>
                                          16
                                      ),
                    ...
                    for (;;)
                      switch ((o.prev = o.next)) {
                        case 0:
                          (t = t.substring(0, 900)),
                            ((n =
                              document.createElement("canvas")).width = 1600),
                            (n.height = 1600),
                            (r = n.getContext("2d")).clearRect(
                              0,
                              0,
                              1600,
                              1600
                            ),
                            r.rotate((9.4 * Math.PI) / 180),
                            (r.font = "108px CustomFont"),
                            (r.fillStyle = "#81D4FA"),
                            (i = "".concat(t.length)),
                            r.fillText(
                              "".concat(i, "/900"),
                        ...
                        switch ((h.prev = h.next)) {
                          ...
                          case 10:
                            return (
                              ...
                              (h.next = 14),
                              o.a.awrap(this.getText(t, "rgba(0, 0, 0, 0.75)"))
                            );
                          case 14:
                            if (
                              ((s = h.sent),
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              this.loading(!0),
                              (t.next = 3),
                              o.a.awrap(this.loadFonts())
                            );
                          case 3:
                            return (
                              (t.next = 5), o.a.awrap(this.loadOriginImage())
                            );
                          case 5:
                            return (
                              (t.next = 7),
                              o.a.awrap(this.generateImage("有内鬼 终止交易"))
                            );
                          case 7:
                            this.loading(!1);
                          case 8:
              ...
              },
              {
                ...
                value: function () {
                  (this.donateModal = new h.modal({
                    ...
                    this.donateModal.setContent(
                      "<h1 style='line-height: 1.5'>我最近又开发了一款好玩的二次元自拍生成器！</h1>"
                    ),
                    this.donateModal.addFooterBtn(
                      "立即体验",
                      "tingle-btn tingle-btn--primary",
                      function () {
                        window.location.href = "https://www.noddl.me";
                      }
                    );
                }
              },
